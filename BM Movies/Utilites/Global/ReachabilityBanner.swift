...
class ReachabilityBanner {
    ...
    init() {
        view = UIView(frame: CGRect(x: 0, y: -50, width: UIScreen.main.bounds.width, height: 100))
        lbl = UILabel(frame: CGRect(x: 0, y: 30, width: UIScreen.main.bounds.width, height: 80))
